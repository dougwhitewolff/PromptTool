...
// === Updated Section: Define the project root to the specified directory ===
// You can use an absolute path to ensure the script targets the correct directory.
// Make sure to use forward slashes or double backslashes for Windows paths.
const projectRoot = path.resolve('C:/Development/reDo');
 ...
 */
const inclusionList = []; // List specific files to include. Leave empty to include all files matching the rules.
...
const concatenateFiles = () => {
  ...
  const outputFile = path.join(
    projectRoot, // Changed from scriptDir to projectRoot
